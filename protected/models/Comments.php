...
class Comments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('parent, create_user_id, commented_user_id, image, time', 'numerical', 'integerOnly'=>true),
			array('text', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, parent, create_user_id, commented_user_id, text, image, time', 'safe', 'on'=>'search'),
		);
	}
