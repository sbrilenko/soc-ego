 ...
 */
class YumUsergroup extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('image, completed, title, description, pm', 'required'),
    ...
    public function getParticipantDataProvider() {
        $criteria = new CDbCriteria;
        $this->participants=empty($this->participants)?array():explode(',',$this->participants);
